...
| TOON | __format=toon | List/Array/Map/String results | Output serialized in [TOON](https://github.com/nmaguiar/toon) (Token-Oriented Object Notation), a compact JSON-like text format. By default this is generated by OpenAF's native json-io/java-util TOON engine (see `af.toTOON`/`__flags.ALTERNATIVES.toTOON` in [javascript2oaf.md](javascript2oaf.md)) rather than a terminal rendering library. |