...
[oJob YAML Reference](./ojob-yaml-reference.md) | [Security](./ojob-security.md) | [Flags Cheat Sheet](../cheat-sheet/oaf-flags.md) | [OpenAF Reference](../advanced/openaf-reference.md)
...
---
See also: [oJob Security](./ojob-security.md) for hardening and the [Flags Cheat Sheet](../cheat-sheet/oaf-flags.md) for tuning knobs.
